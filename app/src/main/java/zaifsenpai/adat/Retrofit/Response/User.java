...
public class User {
     ...
     * @param username
     */
    public User(String id, String updatedAt, String username, String name, String firstName, String lastName, String twitterUsername, Object portfolioUrl, String bio, String location, Links_ links, ProfileImage profileImage, String instagramUsername, Integer totalCollections, Integer totalLikes, Integer totalPhotos, Boolean acceptedTos) {
        super();
        this.id = id;
